...
<template>
    <form @submit.prevent="updateProfileInformation" class="grid grid-cols-1 sm:grid-cols-3 gap-x-12 gap-y-6">
        ...
        <!-- Email -->
        <div>
            <InputLabel for="contact" :value="$t('Best way to contact me is...')" />
        ...
        <div class="col-span-2">
            <div class="grid col-span-1 sm:grid-col-span-2 gap-6">
                ...
                <div>
                    <InputLabel for="contact_id" :value="$t('How we find you there? (ID, username, @, number, etc)')" />
                    <TextInput
                        id="contact_id"
                ...
                <div class="col-span-2">
                    <InputLabel for="contact_how" :value="$t('Tell us how')" />
                    <textarea
                        id="contact_how"
