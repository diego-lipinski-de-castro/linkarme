...
const links = computed(() => {
    const _links = props.types.links
    _links.shift()
    _links.pop()
    return _links
})
...
const destroy = (type) => {
    Inertia.delete(route('types.destroy', type), {
        preserveScroll: true,
        preserveState: true,
    })
}
            ...
            <div class="rounded-md bg-white px-5 py-6 shadow sm:px-6">
                <div class="flex flex-col min-h-48">
                    ...
                    <div class="flex justify-between items-center space-x-2">
                        ...
                        <span class="px-1 text-sm font-medium text-white">{{ $t('Add type') }}</span>
                        </Link>
                    </div>
                </div>
            </div>
                        ...
                        <div
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="divide-y divide-gray-200 bg-white">
                                    <tr v-for="(type, index) in types.data" :key="index" class="bg-white">
