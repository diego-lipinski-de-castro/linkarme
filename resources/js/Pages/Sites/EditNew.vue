...
<template>
    <AppSuspense>
        ...
        <TransitionRoot as="template" :show="showOffersDialog">
            <Dialog as="div" class="relative z-10" @close="showOffersDialog = false">
                <TransitionChild as="template" enter="ease-out duration-300" enter-from="opacity-0" enter-to="opacity-100"
                    leave="ease-in duration-200" leave-from="opacity-100" leave-to="opacity-0">
                    <div class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity" />
                </TransitionChild>
        ...
        <AppLayoutNew :title="$t('Edit site')">
                            ...
                            <form @submit.prevent="submit(false)" class="grid grid-cols-1 sm:grid-cols-6 gap-x-6 gap-y-6">
                                ...
                                <div class="col-span-6">
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <button @click="showOffersDialog = true" type="button" class="text-blue-500 hover:text-blue-700 text-sm">{{ $t('See offers') }} ({{ site.offers_count }})</button>
                                    </div>
            ...
            <div v-show="tabIndex == 1" class="mt-5 min-w-full overflow-hidden overflow-x-auto align-middle border border-gray-200 sm:rounded-md">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="divide-y divide-gray-200 bg-white">
                        <tr v-for="(order, index) in site.orders" :key="index" class="bg-white">
                            <td
            ...
            <div v-show="tabIndex == 3" class="mt-5 min-w-full overflow-hidden overflow-x-auto align-middle border border-gray-200 sm:rounded-md">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="divide-y divide-gray-200 bg-white">
                        <tr v-for="(view, index) in site.views" :key="index" class="bg-white">
                            <td
                                class="whitespace-nowrap px-4 py-4 text-sm text-gray-500">
                                {{ view.client.name }}
                            </td>
