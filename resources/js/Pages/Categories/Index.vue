                                ...
                                <tr v-for="(category, index) in categories.data" :key="index" class="bg-white">
                                    ...
                                    <td class="whitespace-nowrap px-6 py-4 text-sm">
                                        <div class="flex space-x-2">
                                            <Link :href="route('categories.edit', category.id)" class="text-blue-500 hover:text-blue-700">
                                                <PencilSquareIcon class="h-5 w-5"/>
                                            </Link>

                                            <button @click="destroy(category.id)" class="text-red-500 hover:text-red-700">
