        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <form @submit.prevent="submit" class="flex flex-col space-y-6 p-6 bg-white border-b border-gray-200">
                ...
                <div>
                    ...
                    <div class="mt-1 flex rounded-md shadow-sm">
                        <div class="w-full relative flex items-stretch flex-grow focus-within:z-10">
                            <TextInput id="password" v-model="form.password" :type="showPassword ? 'text' : 'password'" class="block w-full rounded-none rounded-l-md" required autocomplete="current-password" />
                        </div>
                ...
                <div>
                    ...
                    <TextInput id="phone" v-model="form.phone" type="text" class="mt-1 block w-full" required autofocus autocomplete="phone" />
