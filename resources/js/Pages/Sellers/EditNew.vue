...
const { seller, token } = defineProps({
    seller: Object,
    coins: Object,
    token: String,
});
...
const form = useForm({
    ...
    comission_coin: seller.comission_coin,
});
...
<template>
    <AppSuspense>
        <AppLayoutNew :title="$t('Edit seller')">
            <div
                class="max-w-7xl mx-auto rounded-md bg-white shadow overflow-hidden pt-5"
            >
                            ...
                            <div>
                                ...
                                <div class="mt-1 relative rounded-md shadow-sm">
                                    <input
                                        ...
                                        v-money3="coins[form.comission_coin]"
                                        type="text"
                                        name="comission"
                                        id="comission"
                                ...
                                <InputError
                                    :message="form.errors.comission"
                                    class="mt-2"
                                />
                            </div>

                            <div>
                                <InputLabel for="token" :value="`API Key (${seller.tokens.length})`" />
