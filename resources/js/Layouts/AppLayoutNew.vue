...
const navigation = [
    ...
    { name: t('Notifications'), href: route('notifications.index'), icon: ClockIcon, current: route().current('notifications.*') },
]
        ...
        <div class="flex flex-col h-screen">
            ...
            <div class="relative bg-gradient-to-b from-blue-700 via-blue-500 to-blue-400 pb-32">
                ...
                <Disclosure as="nav" class="relative z-10 border-b border-white border-opacity-50 lg:border-none"
                    v-slot="{ open }">
                    <div class="mx-auto max-w-[1600px] px-2 sm:px-4 lg:px-8">
                        <div
                            ...
                            <div class="flex flex-1 justify-end items-center px-2 lg:justify-end">

                                <Menu as="div" class="relative">
                                    <MenuButton
                                        class="flex max-w-xs items-center bg-white bg-opacity-[15%] text-sm focus:outline-none rounded-md p-2">
                                    ...
                                    <transition enter-active-class="transition ease-out duration-100"
                                        ...
                                        <MenuItems class="absolute right-0 z-10 mt-2 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                                ...
                                <Menu as="div" class="relative ml-2">
                                    <MenuButton
                                        class="flex max-w-xs items-center text-sm focus:outline-none rounded-md p-2">
                                    ...
                                    <transition enter-active-class="transition ease-out duration-100"
                                        ...
                                        leave-to-class="transform opacity-0 scale-95">
                                        <MenuItems
                                            class="absolute right-0 z-10 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                            ...
                            <div class="flex lg:hidden">
                                <DisclosureButton
                                    class="inline-flex items-center justify-center rounded-md p-2 text-blue-200 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-blue-600">
            ...
            <main class="-mt-24 sm:-mt-32 mb-auto relative">
                <div class="mx-auto max-w-[1600px] px-4 pb-12 sm:px-6 lg:px-8">
                    <slot />
                </div>
            </main>

            <footer class="bg-blue-900">
                <div class="flex justify-end items-center space-x-12 mx-auto max-w-[1600px] px-4 py-8 sm:px-6 lg:px-8">
