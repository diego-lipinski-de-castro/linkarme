                        ...
                        <div class="relative flex h-16 items-center justify-between lg:border-b lg:border-blue-400 lg:border-opacity-25">
                            ...
                            <div class="flex flex-1 justify-end items-center px-2 lg:justify-end">
                                ...
                                <Menu as="div" class="relative">
                                    <MenuButton class="flex max-w-xs items-center bg-white bg-opacity-[15%] text-sm focus:outline-none rounded-md p-2">
                                ...
                                <Menu as="div" class="relative ml-2">
                                    <MenuButton class="flex max-w-xs items-center text-sm focus:outline-none rounded-md p-2">
                                    ...
                                    <transition enter-active-class="transition ease-out duration-100"
                                        ...
                                        leave-from-class="transform opacity-100 scale-100"
                                        leave-to-class="transform opacity-0 scale-95">
                                        <MenuItems class="absolute right-0 z-10 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
