                                ...
                                <transition enter-active-class="transition ease-out duration-100"
                                    ...
                                    <MenuItems
                                        ...
                                        <MenuItem v-slot="{ active }">
                                            <button @click="loadLanguage('en')" :class="[active ? 'bg-gray-100' : '', 'block px-2 py-2 w-12 h-12']">
                                        ...
                                        <MenuItem v-slot="{ active }">
                                            <button @click="loadLanguage('pt-BR')" :class="[active ? 'bg-gray-100' : '', 'block px-2 py-2 w-12 h-12']">
