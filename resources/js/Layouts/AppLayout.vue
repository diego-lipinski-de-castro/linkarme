                                ...
                                <transition enter-active-class="transition ease-out duration-100"
                                    ...
                                    <MenuItems
                                        ...
                                        <MenuItem v-slot="{ active }">
                                            <button @click="setCoin('USD')" :class="[active ? 'bg-gray-100' : '', 'w-full block px-4 py-2 text-sm text-gray-700 text-left']">
                                                USD
                                            </button>
                                        </MenuItem>

                                        <MenuItem v-slot="{ active }">
                                            <button @click="setCoin('BRL')" :class="[active ? 'bg-gray-100' : '', 'w-full block px-4 py-2 text-sm text-gray-700 text-left']">
                                                BRL
                                            </button>
                                        </MenuItem>
                            ...
                            <Menu as="div" class="relative ml-3">
                                ...
                                <transition enter-active-class="transition ease-out duration-100"
                                    ...
                                    <MenuItems
                                        ...
                                        <MenuItem v-slot="{ active }">
                                            <button @click="languageStore.loadLanguage('en')" :class="[active ? 'bg-gray-100' : '', 'block px-2 py-2 w-12 h-12']">
                                                <img src="data:image/png;base64,">
                                            </button>
                                        </MenuItem>

                                        <MenuItem v-slot="{ active }">
                                            <button @click="languageStore.loadLanguage('pt-BR')" :class="[active ? 'bg-gray-100' : '', 'block px-2 py-2 w-12 h-12']">
                                                <img src="data:image/png;base64,">
                                            </button>
                                        </MenuItem>
                            ...
                            <Menu as="div" class="relative ml-3">
                                <div>
                                    <MenuButton
                                        ...
                                        <span class="ml-3 hidden text-sm font-medium text-gray-700 lg:block">{{ $page.props.user.name
                                                }}</span>
                                        <ChevronDownIcon
