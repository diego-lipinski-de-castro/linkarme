<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('countries.create') }}" class="inline-flex items-center px-4 px-3 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150">Adicionar país</a>
        </div>
    </x-slot>
                        ...
                        @foreach ($countries as $country)
                            ...
                            <tr>
                                ...
                                <td class="flex relative whitespace-nowrap px-3 py-2 text-sm border-l">
                                    <a href="{{ route('countries.edit', $country->id) }}" class="font-medium text-blue-600 hover:text-blue-900">
