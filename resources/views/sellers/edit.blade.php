                    ...
                    <form action="{{ route('sellers.update', $seller->id) }}" method="POST">
                        ...
                        <div class="col-span-2">
                            ...
                            <div class="col-span-2">
                                ...
                                <div class="mt-1">
                                    <input value="{{ old('phone', $seller->phone) }}" type="text" name="phone" id="phone" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md @error('phone') border-red-300 @enderror" placeholder="João" />
                                </div>
