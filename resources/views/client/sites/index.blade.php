                    ...
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th scope="col" class="whitespace-nowrap px-3 py-3 text-left text-sm font-semibold text-gray-900 border-l">
                                <a href="{{ route('client.sites.index', [ 'sort' => $sort == 'orders_count' ? '-orders_count' : 'orders_count' ]) }}" class="group inline-flex cursor-pointer">
                                    Pedidos

                                    <span class="{{ str_starts_with($sort, 'orders_count') ? '' : 'rotate-180' }} {{ str_contains($sort, 'orders_count') ? 'bg-gray-200 text-gray-900 group-hover:bg-gray-300' : 'invisible text-gray-400 group-hover:visible group-focus:visible' }} ml-2 flex-none rounded">
                                        <!-- Heroicon name: solid/chevron-down -->
                                        <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                            <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd" />
                                        </svg>
