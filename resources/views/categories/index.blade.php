                ...
                <table class="min-w-full divide-y divide-gray-300">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th scope="col" class="relative whitespace-nowrap px-3 py-3 border-l">
                    ...
                    <tbody class="divide-y divide-gray-200 bg-white">
                        ...
                        @foreach ($categories as $category)
                            <tr>
                                ...
                                <td class="whitespace-nowrap px-3 py-2 justify-end text-sm border-l">
                                    <div class="flex">
                                        <a href="{{ route('categories.edit', $category->id) }}" class="font-medium text-blue-600 hover:text-blue-900">
