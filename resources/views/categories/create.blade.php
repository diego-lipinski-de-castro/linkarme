                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('categories.store') }}" method="POST">
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                              <input type="text" name="name" id="name" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md @error('name') border-red-300 @enderror" placeholder="Ex.: Entretenimento" />
                            </div>
